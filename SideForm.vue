<template>
              ...
              <form @submit.prevent="submitTourRequest">
                <div class="row">
                  ...
                  <div class="col-12 my-1">
                    ...
                    <span v-if="isLoading">
                      <i class="fa fa-spinner fa-spin"></i>{{ $t('Submitting...')}}  
                    </span>
  ...
  <el-dialog v-model="noAuthDialog" title="Alert" width="500" align-center>
    <span>
      {{ $t('You can send a tour request  only if you are authenticated. Please log in or sign up first to access this feature.')}} 
    </span>
    <template #footer>
      <div class="dialog-footer">
        <el-button @click="noAuthDialog = false">{{ $t('Cancel')}} </el-button>
