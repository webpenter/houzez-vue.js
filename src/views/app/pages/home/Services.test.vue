  ...
  <div class="container-fluid my-5 pt-5" style="background: #C4A484;">
    <section>
      <div class="text-center mb-5">
        <h2 class="font-weight-bold display-4 text-white">Our Services</h2>
      </div>
      <div class="row">
        <div class="col-md-4 mx-2 my-2 bg-light">
          <div class="px-3 my-5">
            <div class="circle text-white rounded-circle d-flex align-items-center justify-content-center mx-auto mb-4"
                 style="width: 60px;height: 60px; background-color: #6f4e37">
              <svg height="30px" fill="currentColor" version="1.1" id="Layer_1"
                   xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                   y="0px" viewBox="0 0 458.571 458.571" style="enable-background:new 0 0 458.571 458.571;"
                   xml:space="preserve">
                                <g id="XMLID_657_">
                                    <g>
                                        <g>
            ...
            <div class="px-3 text-center pb-3">
              ...
              <p class="font-weight-light my-3">Lorem ipsum dolor sit consectetur adipisicing elit. Alias
                amet deleniti et fugit iusto nesciunt.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 my-2 mx-2 bg-light">
          <div class="px-3 my-5">
            <div class="circle text-white rounded-circle d-flex align-items-center justify-content-center mx-auto mb-4"
                 style="width: 60px;height: 60px; background-color: #6f4e37">
        ...
        <div class="col-md-4 my-2 mx-2 bg-light">
          <div class="px-3 my-5">
            <div class="circle text-white rounded-circle d-flex align-items-center justify-content-center mx-auto mb-4"
                 style="width: 60px;height: 60px; background-color: #6f4e37">
              <svg height="30px" fill="currentColor" version="1.1" id="Capa_1"
                   xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                   y="0px" viewBox="0 0 54 54" style="enable-background:new 0 0 54 54;"
                   xml:space="preserve">
                                <g>
                                    <path
...
const services2 = [
  {
    ...
    description: "Property management is the operation, control, and oversight of real estate to ensure its upkeep, value, and profitability.",
    image: "",
  },
  {
    id: 2,
    title: "Business Development",
    description: "Business development involves identifying growth opportunities, building strategic partnerships, and increasing revenue through market expansion and customer engagement.",
    image: "",
  },
  {
    id: 3,
    title: "Finance Real Estate",
    description: "Finance real estate involves managing funds for property investment, including securing loans, analyzing risks, and maximizing returns on real estate assets.",
    image: "",
  },
];
