					...
					<div class="col-sm-12 col-xs-12">
						<div class="form-group mb-2">
							<label class="control control--checkbox m-0">
								<input type="checkbox" name="air-conditioning" checked>Keep me informed about similar
								properties.
								<span class="control__indicator"></span>
							</label>
							<label class="control control--checkbox m-0">
								<input type="checkbox" name="dgpr-agreement">By submitting this form I agree to <a
									href="#">Terms of Use</a>
								<span class="control__indicator"></span>
							</label>
						</div><!-- form-group -->
