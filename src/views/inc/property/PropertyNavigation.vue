<template>
	...
	<div class="container-fluid">
		<ul class="property-navigation list-unstyled d-flex justify-content-between">
			...
			<li class="property-navigation-item">
				<a class="target" href="#property-sub-listings-wrap">Sub Listings</a>
			</li>
			<li class="property-navigation-item">
				<a class="target" href="#property-overview-wrap">Overview</a>
			</li>
			<li class="property-navigation-item">
			...
			<li class="property-navigation-item">
				<a class="target" href="#property-availability-calendar-wrap">Calendar</a>
			</li>
			<li class="property-navigation-item">
