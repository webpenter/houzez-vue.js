<template>
	...
	<td data-label="Property" class="table-nowrap">
		<a href="#"><strong>Apartment With Ocean View</strong></a>
	</td>
	<!-- <td class="property-table-id" data-label="ID">HZ-001</td> -->
	<td data-label="Last Message">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua...</td>
