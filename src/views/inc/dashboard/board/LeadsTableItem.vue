<template>
	<tr class="table-new">
		...
		<td class="table-nowrap" data-label="Name">
			Martin Moore
			<a href="crm-lead-enquiries.php" class="board-message-icon-wrap ml-2 fa-lg active" data-toggle="tooltip"
				data-placement="top" title="View enquiry">
		...
		<td>
			<div class="dropdown property-action-menu">
				...
				<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
					<router-link to="/dashboard/crm-lead-enquiries" class="dropdown-item">
						Details
					</router-link>

					<a class="dropdown-item open-close-slide-panel" href="#"
						@click.prevent="toggleModalAddNewLead">Edit</a>
