		...
		<div class="doughnut-chart-data flex-fill">
			<ul class="list-unstyled">
				<li class="stats-data-1">
					<i class="houzez-icon icon-sign-badge-circle mr-1"></i> <strong>Chrome</strong> <span>1,5k <small>Views</small></span>
				</li>
				<li class="stats-data-2">
					<i class="houzez-icon icon-sign-badge-circle mr-1"></i> <strong>Safari</strong> <span>$2,4k <small>Views</small></span>
				</li>
				<li class="stats-data-3">
					<i class="houzez-icon icon-sign-badge-circle mr-1"></i> <strong>Internet Explorer</strong> <span>1,3k <small>Views</small></span>
				</li>
				<li class="stats-data-4">
					<i class="houzez-icon icon-sign-badge-circle mr-1"></i> <strong>Others</strong> <span>786 <small>Views</small></span>
				</li>
			</ul>
