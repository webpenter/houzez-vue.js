	...
	<div class="map-wrap">
		...
		<div class="map-next-prev-actions">
			<ul class="dropdown-menu" aria-labelledby="houzez-gmap-view">
				<li class="dropdown-item"><a href="" class="homeyMapType"
						data-maptype="roadmap"><span>Roadmap</span></a></li>
				<li class="dropdown-item"><a href="" class="homeyMapType"
						data-maptype="satellite"><span>Satelite</span></a></li>
				<li class="dropdown-item"><a href="" class="homeyMapType" data-maptype="hybrid"><span>Hybrid</span></a>
				</li>
				<li class="dropdown-item"><a href="" class="homeyMapType"
						data-maptype="terrain"><span>Terrain</span></a></li>
			</ul>
