	...
	<div class="block-wrap">
		...
		<div class="block-content-wrap">
			<ul class="list-2-cols list-unstyled">
				<li><strong>{{ $t('Address') }}:</strong> <span>{{ property.address }}</span></li>
				<li><strong>{{ $t('City') }}:</strong> <span>{{ property.city }}</span></li>
				<li><strong>{{ $t('State/County') }}:</strong> <span>{{ property.county_state }}</span></li>
				<li><strong>{{ $t('Zip Code') }}:</strong> <span>{{ property.zip_postal_code }}</span></li>
				<li><strong>{{ $t('Neighborhood') }}:</strong> <span>{{ property.neighborhood }}</span></li>				
				<li><strong>{{ $t('Country') }}:</strong> <span>{{ property.country }}</span></li>
			</ul>	
