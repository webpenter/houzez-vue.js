        ...
        <div class="dashboard-content-block-wrap">
          ...
          <div class="dashboard-content-block">
            <div class="form-group">
              <label>Title *</label>
              <input class="form-control" :class="{ 'is-invalid': localErrors.title }" @input="validateField('title')"
                v-model="formData.title" placeholder="Enter the property title" type="text">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" v-model="formData.description" rows="10"
                placeholder="Enter the property description"></textarea>
            </div>
            <div class="row">
              ...
              <div class="col-md-4 col-sm-12">
                <div class="form-group">
                  <label>Status</label>
                  <div>
                    <el-select v-model="formData.status" filterable default-first-option :reserve-keyword="false"
                      placeholder="Choose status for your property" style="width: 300px">
              ...
              <div class="col-md-4 col-sm-12">
                <div class="form-group">
                  <label>Label</label>
                  <div>
                    <el-select v-model="formData.label" filterable default-first-option :reserve-keyword="false"
                      placeholder="Choose label for your property" style="width: 300px">
