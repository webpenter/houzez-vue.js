                    ...
                    <div class="dashboard-content-inner-wrap">
                        <div class="dashboard-content-block-wrap">
                            <div class="dashboard-content-block">
                                <DashboardSelectPayment/>
                                <!-- <button type="button" class="btn btn-success btn-full-width mt-4 mb-4" onclick="window.location.href='payment-completed'">
                                    Complete Membership
                                </button> -->
                                <RouterLink :to="{name:'dashboard.create-listing.payment-completed'}" class="btn btn-success btn-full-width mt-4 mb-4">
                                    Complete Membership
                                </RouterLink>
